...
inline namespace dotenv {
    ...
    public:
        enum CHAR_MODE { INCLUDE = 0, EXCLUDE = 1 };
        ...
        inline const container_t& include() const { return _include; }
        inline const container_t& exclude() const { return _exclude; }
